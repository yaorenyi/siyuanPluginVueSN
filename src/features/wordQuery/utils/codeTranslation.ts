...
export const NAMING_STYLES: NamingStyle[] = [
  { id: 'camelCase', label: '驼峰命名', description: '首个单词小写，后续单词首字母大写', example: 'getUserInfo' },
  { id: 'PascalCase', label: '帕斯卡命名', description: '每个单词首字母大写', example: 'GetUserInfo' },
  { id: 'snake_case', label: '下划线命名', description: '单词间用下划线连接，全小写', example: 'get_user_info' },
  { id: 'kebab-case', label: '短横线命名', description: '单词间用短横线连接，全小写', example: 'get-user-info' },
  { id: 'SCREAMING_SNAKE_CASE', label: '常量命名', description: '单词间用下划线连接，全大写', example: 'GET_USER_INFO' }
]
...
export async function translateCodeField(
  ...
  const messages = [
    { role: 'system', content: '你是一个专业的编程翻译助手，擅长将中文翻译成符合编程命名规范的英文。' },
