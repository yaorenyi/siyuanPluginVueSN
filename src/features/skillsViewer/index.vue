<!-- Skills 查看器 — 查看和管理 AI 编程工具的 Skills 配置文件 -->
<template>
  <Teleport to="body">
              ...
              <template v-if="managerAvailable">
                ...
                >
                  <SkillCard
                    ...
                    @delete="confirmDeleteSkill(index)"
                    @copy="confirmCopySkill(index)"
...
import type {
  AIToolType,
  SkillInfo,
} from "./types/SkillsViewerManager"
