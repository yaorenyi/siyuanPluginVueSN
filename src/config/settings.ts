 ...
 * 加载标题设置
 */
export async function loadHeadingSettings(
	plugin: Plugin,
): Promise<HeadingSettings> {
	try {
 ...
 * 加载代码块设置
 */
export async function loadCodeBlockSettings(
	plugin: Plugin,
 ...
 * 保存代码块设置
 */
export async function saveCodeBlockSettings(
	plugin: Plugin,
 ...
 * 加载列表设置
 */
export async function loadListSettingsFromDB(
	plugin: Plugin,
 ...
 * 保存列表设置
 */
export async function saveListSettingsToDB(
	plugin: Plugin,
 ...
 * 加载高亮设置
 */
export async function loadHighlightSettings(
	plugin: Plugin,
): Promise<{ enableHighlight: boolean }> {
	try {
 ...
 * 保存高亮设置
 */
export async function saveHighlightSettings(
	plugin: Plugin,
	settings: { enableHighlight: boolean },
): Promise<boolean> {
	try {
 ...
 * 从数据库加载字体设置
 */
export async function loadFontSettingsFromDB(
	plugin: Plugin,
 ...
 * 保存字体设置到数据库
 */
export async function saveFontSettingsToDB(
	plugin: Plugin,
 ...
 * 加载钉住页签设置
 */
export async function loadTabPinSettings(
	plugin: Plugin,
): Promise<TabPinSettings> {
	try {
 ...
 * 保存钉住页签设置
 */
export async function saveTabPinSettings(
	plugin: Plugin,
